...
4. memasang `PendingIntent` immutable yang membuka `MainActivity` saat notifikasi ditekan, dengan `SINGLE_TOP|CLEAR_TOP` agar tidak membuat task atau Activity duplikat.
